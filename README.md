...
O objetivo do projeto foi criar uma página web simples que demonstrasse os conhecimentos em desenvolver código front-end com Javascript, HTML e CSS, utilizando um servidor simples em Python. Foi escolhido desenvolver um jogo da velha com a implementação de uma "IA" em Javascript para executar os comandos do computador. Para o servidor foi utilizado a biblioteca http.server do Python.
